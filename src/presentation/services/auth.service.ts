    ...
    const html = `
        <div style="margin: 0 auto; width: 120rem; max-width: 95%;">
          ...
          <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; margin: 0 auto; max-width: 95%; width: 450px;"> 
            ...
            <a style="background-color: #623637; text-decoration: none; color: #fff; width: 100%; display: inline-block; padding: 10px; text-align: center;" href="https://cerulean-pie-03598d.netlify.app/auth/confirm/${token}/${email}">Presiona aqui</a>
          </div>
          ${bottomEmail}
        </div>
      `;
    ...
    const htmlBody = `
      <div style="margin: 0 auto; width: 120rem; max-width: 95%;">
        ...
        <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; margin: 0 auto; max-width: 95%; width: 450px;"> 
          ...
          href="https://cerulean-pie-03598d.netlify.app/auth/password/new-password/${token}">Ir a cambiar</a>
